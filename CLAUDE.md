...
│   ├── 02_embed.py
│   ├── 03_insert_nodes.py
│   ├── 04_l15_edges.py        # cosine-driven L15 BE formation
│   ├── 05_word_vectors.py     # BE-centroid + orphan senses
│   ├── 06_l14_edges.py        # kaikki-driven, fermion order
│   ├── 07_orphan_reentry.py   # L15 then L14 orphan absorption
│   ├── 08_metabary.py         # L13 triads + L12→L1 recursive
│   ├── 09_summarize.py        # async LLM summaries
│   ├── 10_index.py
│   └── eval/
│       ├── holdout.py
│       ├── recall.py
...
|---|---|---|
| 1. Parse + Embed | `01_parse.py`, `02_embed.py` | Yes |
| 2. Insert nodes | `03_insert_nodes.py` | Yes |
| 3. L15 BE formation | `04_l15_edges.py` | Yes |
| 4. L14 word vectors | `05_word_vectors.py` | Yes |
| 5. L14 BE formation | `06_l14_edges.py` | Yes |
| 6. Orphan re-entry | `07_orphan_reentry.py` | Yes |
| 7. MetaBary (L13→L1) | `08_metabary.py` | Yes |
| 8. Summarize | `09_summarize.py` | **No — async** |
| 9. Index | `10_index.py` | Yes |
